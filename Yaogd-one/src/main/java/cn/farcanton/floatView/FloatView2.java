...
public class FloatView2 extends ImageView{ 
	//用来计算位移
	...
	private WindowManager windowManager = FloatApplication.getInstence().getWinManager();
	// 此windowManagerParams变量为获取的全局变量，用以保存悬浮窗口的属性 
	private WindowManager.LayoutParams windowManagerParams = FloatApplication.getInstence().getFloatDldWindowParams(); 
