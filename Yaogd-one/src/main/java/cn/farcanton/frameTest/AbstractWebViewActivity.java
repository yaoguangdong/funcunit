...
import cn.farcanton.floatButton.FloatApplication;
...
public abstract class AbstractWebViewActivity extends Activity implements AsyncActivity {
    ...
    // ***************************************
    @Override
    public FloatApplication getApplicationContext() {
        return (FloatApplication) super.getApplicationContext();
    }
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        webView.setWebChromeClient(new WebChromeClient() {
            public void onProgressChanged(WebView view, int progress) {
                ...
                if (progress == 100) {
                    activity.setTitle("nihao  webView  process");
                }
            }
        });
    }
