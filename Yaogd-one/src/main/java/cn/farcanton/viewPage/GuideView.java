...
public class GuideView extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        View v5 = inflater.inflate(R.layout.guide_view_item05, null);
        View v6 = inflater.inflate(R.layout.guide_view_item06, null);
        View v1 = inflater.inflate(R.layout.guide_view_item01, null);
        View v2 = inflater.inflate(R.layout.guide_view_item02, null);
        View v3 = inflater.inflate(R.layout.guide_view_item03, null);
        View v4 = inflater.inflate(R.layout.guide_view_item04, null);
        ...
        main = (ViewGroup)inflater.inflate(R.layout.guide_view_main, null);  
    ...
    private class TextViewOnClickListener implements OnClickListener{
    	...
    	public void onClick(View v) {
    		...
    		Toast.makeText(GuideView.this, ((TextView) v).getText(), Toast.LENGTH_LONG).show();
    	}
    }
    ...
    private class GuidePageChangeListener implements OnPageChangeListener {  
        ...
        public void onPageSelected(int arg0) {  
            for (int i = 0; i < imageViews.length; i++) {  
                imageViews[arg0].setBackgroundResource(R.drawable.guide_view_page_indicator_focused);
