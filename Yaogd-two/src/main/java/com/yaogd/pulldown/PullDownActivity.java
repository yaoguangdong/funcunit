...
import com.yaogd.R;
import com.yaogd.pulldown.PullDownView.OnPullDownListener;
	...
	private Handler mUIHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case WHAT_DID_LOAD_DATA: {
				...
				Toast.makeText(PullDownActivity.this, ""+mListView.getAdapter().getCount(), Toast.LENGTH_LONG).show();
				// 诉它数据加载完毕;
				break;
			}
