...
public class CameraMask extends View {
	...
	public CameraMask(Context paramContext, AttributeSet paramAttributeSet) {
		...
		this.m_Box = new Rect();
		this.mMaskColor = Color.parseColor("#1100AA");
		this.mFrameColor = Color.parseColor("#009900");
		Display localDisplay = ((WindowManager) mCxt.getSystemService(Context.WINDOW_SERVICE)).getDefaultDisplay();
